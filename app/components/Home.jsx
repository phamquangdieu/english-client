...
export default function HomeScreen() {
  ...
  return (
    <div
      ref={container}
      className="bg-home bg-gray-300 flex flex-col gap-12 w-full h-[100vh] justify-center items-center"
    >
      <button
      ...
      >
        <div className="text-2xl p-4 text-center text-white">Kiểm tra</div>
      </button>
    </div>
  );
}
